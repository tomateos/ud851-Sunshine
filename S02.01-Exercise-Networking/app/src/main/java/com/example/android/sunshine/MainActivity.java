...
public class MainActivity extends AppCompatActivity {
    ...
    public class FetchWeatherTask extends AsyncTask<URL, Void, String[]> {
        ...
        protected String[] doInBackground(URL... params) {
            ...
            weatherRequest = params[0];
            try {
                jsonWeatherResponse = NetworkUtils.getResponseFromHttpUrl(weatherRequest);
                weatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(
                        MainActivity.this,
                        jsonWeatherResponse
                );
            } catch (Exception e) {
        ...
        protected void onPostExecute(String[] weatherData) {
            if (weatherData != null) {
                for (String weatherElement : weatherData) {
                    mWeatherTextView.append(weatherElement + "\n\n\n");
                }
            }
        }
    }
